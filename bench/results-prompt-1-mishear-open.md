...
|---|---|---|---|---|---|---|---|---|
| Qwen3-0.6B-MLX-4bit | 97% | 82% | 0.27s | 1.58s | 1.88s | 0/30 | 9/30 | 3/30 |
...
**Qwen3-0.6B-MLX-4bit / long_ramble** 0.38s 88% recall 100% LOSSY (dropped content): guard rejected it, rules ran instead
...
**Qwen3-0.6B-MLX-4bit / long_doc** 1.40s 92% recall 93% missing 'remembering it'
...
**Qwen3-0.6B-MLX-4bit / agent_prompt_streaming** 1.88s 91% recall 100% REWORDED: subsequence guard rejected it, rules ran instead; LOSSY (reworded content on the coding path): guard rejected it, rules ran instead
...
**Qwen3-0.6B-MLX-4bit / agent_prompt_ui_options** 0.17s 75% recall 100% kept 'you know'; LOSSY (dropped content): guard rejected it, rules ran instead
...
**Qwen3-0.6B-MLX-4bit / agent_prompt_council** 0.36s 86% recall 100% LOSSY (dropped content): guard rejected it, rules ran instead
...
**Qwen3-0.6B-MLX-4bit / design_doc_polish_long** 1.82s 90% recall 100% LOSSY (lost content words): guard rejected it, rules ran instead
...
**Qwen3-0.6B-MLX-4bit / mishear_dev_prod** 0.13s 38% recall 100% REWORDED: subsequence guard rejected it, rules ran instead; missing 'prod'; missing 'middleware'; kept 'proud'; kept 'devin'; LOSSY (reworded content on the coding path): guard rejected it, rules ran instead
